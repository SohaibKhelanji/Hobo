            ...
            foreach ($stmtResultCheck as $stmtRow) {
                echo "
                        ...
                        <figure>
                            ...
                            <button id ='actie-button-bewerken' onclick=\"location.href= 'edit.php?id=$stmtRow[series_id]' \">Bewerken</button>
                            <button id ='actie-button-verwijderen' onclick=\"location.href= 'includes/deleteSeries.php?id=$stmtRow[series_id]' \">Verwijderen</button>
                            </figcaption>
                        </figure>
